...
public class  Delete_2 {
  ...
  public void loginerp() {
	  ...
	  basemethods.driver.findElement(By.xpath( " //input[@value='447']")).click();
	 ...
	 String actualresult = basemethods.driver.findElement(By.id(" ewBreadcrumb2")).getText();
	  Assert.assertEquals( actualresult, "Stock Items");
